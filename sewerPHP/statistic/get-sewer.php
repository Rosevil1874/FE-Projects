...
$sql1 = 
	"SELECT 
		(SELECT COUNT(*) FROM monitor WHERE type='井盖' AND area='岳麓区' AND status='预警') AS 'yuelu_warn',
		(SELECT COUNT(*) FROM monitor WHERE type='井盖' AND area='岳麓区' AND status='告警') AS 'yuelu_danger',
		(SELECT COUNT(*) FROM monitor WHERE type='井盖' AND area='天心区' AND status='预警') AS 'tianxin_warn',
		(SELECT COUNT(*) FROM monitor WHERE type='井盖' AND area='天心区' AND status='告警') AS 'tianxin_danger',
		(SELECT COUNT(*) FROM monitor WHERE type='井盖' AND area='雨花区' AND status='预警') AS 'yuhua_warn',
		(SELECT COUNT(*) FROM monitor WHERE type='井盖' AND area='雨花区' AND status='告警') AS 'yuhua_danger',
		(SELECT COUNT(*) FROM monitor WHERE type='井盖' AND area='芙蓉区' AND status='预警') AS 'furong_warn',
		(SELECT COUNT(*) FROM monitor WHERE type='井盖' AND area='芙蓉区' AND status='告警') AS 'furong_danger',
