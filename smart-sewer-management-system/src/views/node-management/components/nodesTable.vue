        ...
        on: {
            'click': () => {
                if (!currentRow.editting) {
                    ...
                    // 更新数据库中修改项
                    Vue.prototype.$ajax.post('http://localhost/sewer-system/sewerPHP/monitor-management/edit-nodes.php',
                        {
                            data: edittingRow
                        },
                        {
    ...
    return h('Poptip', {
        ...
        on: {
            'on-ok': () => {
                let edittingRow = vm.edittingStore[index];
                // 删除数据库中删除项
                Vue.prototype.$ajax.post('http://localhost/sewer-system/sewerPHP/monitor-management/delete-nodes.php',
                    {
