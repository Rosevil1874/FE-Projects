        ...
        on: {
            'click': () => {
                if (!currentRow.editting) {
                    ...
                    // 更新数据库中修改项
                    Vue.prototype.$ajax.post('http://localhost/sewer-system/sewerPHP/monitor-management/edit-maintain.php',
                        {
                            data: edittingRow
                        },
                        {
    ...
    return h('Poptip', {
        ...
        on: {
            'on-ok': () => {
                let edittingRow = vm.edittingStore[index];
                // 删除数据库中删除项
                Vue.prototype.$ajax.post('http://localhost/sewer-system/sewerPHP/monitor-management/delete-maintain.php',
                    {
                        data: {'deviceId': vm.thisTableData[index].id}
                    },
                    {
                        // 允许跨域
                        headers: {
