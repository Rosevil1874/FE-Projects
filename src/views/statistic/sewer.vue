...
export default {
    ...
    methods: {
        ...
        dateRangeChange (){
            ...
            this.$ajax.post('http://localhost/sewer-system/sewerPHP/statistic/get-sewer-inrange.php',
                {
                    data:data
                },
                {
    ...
    mounted(){
        ...
        this.$ajax.get('http://localhost/sewer-system/sewerPHP/statistic/get-sewer.php',
        ).then( response => {
            let res = response.data[0]
            this.yuelu_warn = res.yuelu_warn
            this.yuelu_danger= res.yuelu_danger
